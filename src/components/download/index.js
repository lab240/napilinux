...
function FileList() {
  ...
  return (
    ...
    <p style={{margin: "20px 10px",}}><a className="button button--primary" href="https://download.napilinux.ru/linuximg/napilinux/napilinux-napi-devs-rk3308bs/" target="_blank">NapiLinux для устройств на базе rk3308 (Napi C/P/S)</a></p>
    <p style={{margin: "20px 10px",}}><a className="button button--primary" href="https://download.napilinux.ru/linuximg/napilinux/napilinux-roc-rk3328-cc/" target="_blank">Napilinux для ROC-rk3328-CC на базе rk3328</a></p>
    <p style={{margin: "20px 10px",}}><a className="button button--primary" href="https://download.napilinux.ru/linuximg/napilinux/napilinux-rockpro64-rk3399/" target="_blank">Napilinux для RockPro 64 на базе rk3399(Pine64)</a></p>
    <a href="https://download.napilinux.ru/linuximg/armbian/">ArmBian for Napi devices</a>
    </div>
  );
}
